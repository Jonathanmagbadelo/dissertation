...
cover = Cover.Cover(spark_session=spark_session, embedding_size=300, x_max=100, alpha=.75, weight_decay=1e-8, learning_rate=0.05, epochs=1, batch_size=512, device_type='cuda')
