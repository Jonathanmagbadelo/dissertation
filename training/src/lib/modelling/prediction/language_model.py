...
from keras.layers import Bidirectional, Dense, Dropout, Activation, Embedding, CuDNNLSTM, regularizers
...
token_to_id, id_to_token, embeddings = utils.load_embeddings("cover_embeddings")
...
co_variate_matrix = utils.load_co_variates("cover_co_variates")
logger.info("Loaded covariates! There are {} covariates".format(len(co_variate_matrix)))
